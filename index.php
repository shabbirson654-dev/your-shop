...
<head>
    ...
    <!-- Animate.css library for Wow animations -->
...
<div id="CarouselExampleControls" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="images/banner.png" class="d-block w-100 img-fluid" alt="E-commerce Banner 1">
        </div>
        <div class="carousel-item">
            <img src="images/banner1.png" class="d-block w-100 img-fluid" alt="E-commerce Banner 2">
        </div>
    ...
    <?php 
      ...
      while ($cat_data=$cat_data_sql->fetch_assoc()) {
        ...
        $cat_name=$cat_data['category_name'];
                   ...
                   // Dynamic WOW entrance sweep animation on grid rows
                   echo '<div class="row wow animate__animated animate__zoomIn" data-wow-duration="0.6s">';
                   echo '<div class="col-12"><h1 class="text-center my-5">'.$cat_name.'</h1></div>';
                   ...
                   while($pro_data=$product_sql->fetch_assoc())
                   {
                      ...
                      echo '
                        ...
                        <div class="col-md-3 mb-5">
                              ...
                              <div class="text-center p-1 mt-2 img-container-fixed">
                              <img src="https:// yourshop.42web.io/shop/product_pic/'.$pro_data['product_pic'].'" width="250" height="250">
                                  ...
                                  <div >
                                   <label class="fs-5 text-dark ">Rs. '.number_format($pro_data['product_amount']).'</label><br>
